                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-group-divider">
                            <tr>
                                <th scope="row">Necesito una Tutoria</th>
                                <td>Matematica</td>
                                <td>Sin Asignar</td>
                                <td>Sin Asignar</td>
                                <td>Julio</td>
                                <td>Esto es un comentario</td>
                                <td><a class="btn btn-primary" href="#" role="button">Ver Estado</a>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Solicito una Tutoria</th>
                                <td>Programacion</td>
                                <td>Sin Asignar</td>
                                <td>Sin Asignar</td>
                                <td>Diciembre</td>
                                <td>Esto es otro comentario</td>
                                <td><a class="btn btn-primary" href="#" role="button">Ver Estado</a>
                                </td>
                            </tr>
                        </tbody>
